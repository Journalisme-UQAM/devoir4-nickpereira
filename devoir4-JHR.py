...
martineau = "../martino.csv" ### ICI, JE FAIS SIMPLEMENT DONNER LE CHEMIN VERS LE FICHIER POUR QUE TON SCRIPT FONCTIONNE SUR MON ORDI

tal = spacy.load("fr_core_news_md")

# f = open(martineau)
f = open(martineau, encoding="utf-8") ### CHANGER CETTE LIGNE AINSI RÈGLE-T-IL LE PROBLÈME??
interventions = csv.reader(f)
next(interventions)

tousMots = []
# bigrams = [] ### INUTILE PUISQUE LA VARIABLE «BIGRAMS» EST UTILISÉE PLUS BAS COMME VARIABLE TEXTE

for inter in interventions:
    doc = tal(inter[3])
    print(inter[1]) ### JE FAIS AFFICHER LA DATE POUR VOIR LA PROGRESSION DE TON SCRIPT
    ...
    print(len(tousMots)) ### SIMPLE AFFICHAGE POUR MESURER LA PROGRESSION DU SCRIPT
...
### DÉSOLÉ QUE TU AIES ÉPROUVÉ TANT DE PROBLÈMES DURANT LA SESSION EN RAISON DE MON INCAPACITÉ À TROUVER DES SOLUTIONS QUI FONCTIONNENT AUSSI BIEN SOUS WINDOWS QUE SOUS MACOS...
### TU ME DIRAS SI LA SOLUTION PROPOSÉE À LA LIGNE 26 DONNE DES RÉSULTATS...